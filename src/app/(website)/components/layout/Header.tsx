...
export default function Header() {
  const navs: Nav[] = [
    ...
    { name: 'Blog', href: '/blog', id: generateId() },
    { name: 'Projects', href: '/projects', id: generateId() },
    { name: 'Contact', href: '/contact', id: generateId() },
    { name: 'More', href: '/more', id: generateId() },
  ];
  return (
    <nav
