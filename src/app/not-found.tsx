  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        {/* 标题 */}
        <h1 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">页面未找到</h1>

        {/* 描述 */}
        <p className="mb-8 text-gray-600 dark:text-gray-400">抱歉，您访问的页面不存在或已被移动。</p>
        ...
        {/* 建议链接 */}
        <div className="mt-8">
          <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">或者您可以尝试：</p>
