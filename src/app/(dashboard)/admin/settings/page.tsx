...
import { Globe, Search, MessageSquare, Shield, Palette, Database, Save, RefreshCw } from 'lucide-react';
            ...
            <Card className="snow-card">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input id="site-name" defaultValue="Blog-Any" placeholder="请输入网站名称" />
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select defaultValue="asia/shanghai">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="america/new_york">美国/纽约 (UTC-5)</SelectItem>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">自动为搜索引擎生成网站地图</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">为社交媒体分享生成 OG 标签</p>
                      </div>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">允许用户在文章下发表评论</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">新评论需要管理员审核后才能显示</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">允许未登录用户发表评论</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">新评论时发送邮件通知给管理员</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="comment-length" type="number" defaultValue="500" placeholder="字符数" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">限制错误登录尝试次数，防止暴力破解</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">将所有 HTTP 请求重定向到 HTTPS</p>
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="backup-retention" type="number" defaultValue="30" placeholder="天数" />
                    </div>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">在网站上显示主题切换按钮</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">允许添加自定义样式代码</p>
                      </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 border border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-900/20 rounded-lg">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      ⚠️ 以下操作可能会影响网站正常运行，请谨慎操作并确保有完整备份。
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">清除所有系统缓存，可能会临时影响性能</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">重新构建搜索索引，提高搜索性能</p>
                      </div>
                      <Button variant="outline" size="sm">
                    ...
                    <div className="flex items-center justify-between p-4 border border-destructive rounded-lg">
                      <div>
                        <h4 className="font-medium text-destructive">重置系统</h4>
                        <p className="text-sm text-muted-foreground">将所有设置恢复为默认值，此操作不可逆</p>
                      </div>
